...
class Login_Activity : AppCompatActivity() {
    ...
    fun signUp() {
        ...
        if (edtpass.text.toString() == editconfirmpass.text.toString()) {
            val signUpUrl =
                "http:///192.168.35.112/OnlinestoreApp/join_new_user.php?email=" + edtemail.text.toString() + "&user=" + username.text.toString() +
    ...
    fun login() {
        val loginUrl = "http:///192.168.35.112/OnlinestoreApp/login_app_user.php?email=" +
